...
### [展示租户内人员](#展示租户内人员)
```
http://10.0.209.147/microservice/workflownew/s/useSession/showTenantStaffList?count=1&pageSize=1&tenantId=t3
```
...
| `tenant` | 租户信息 |
| `invite` | 不用管 |
| `tenantAccBuk` | 租户中人员信息 |
|  | 以下为`tenantAccBuk`中信息 |
| `actReModel`     | 不用管 |
| `actReProcdef`     | 不用管 |
| `avatar` | 人员avatar |
| `id` | 人员id，独一无二 |
...
### [将人员添加到租户](#将人员添加到租户)
```
http://10.0.209.147/microservice/workflownew/s/addTenantStaff?accBukId=eea3867639c14820a77eb6a58abc3624&tenantId=0e3e2d562958469db47ede6ae5b29520
```
